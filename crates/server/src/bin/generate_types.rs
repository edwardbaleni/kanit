...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::execution_process::ExecutorAction::decl(),
        ...
        // REMOVED: Execution disabled - CreateFollowUpAttempt removed
        ...
        // REMOVED: Execution disabled - CreateAndStartTaskRequest removed
        ...
        // REMOVED: Execution disabled - agent setup types removed
        ...
        // REMOVED: Execution disabled - using stub types from services::executor_stubs
        services::executor_stubs::McpConfig::decl(),
        services::executor_stubs::BaseCodingAgent::decl(),
        services::executor_stubs::AvailabilityInfo::decl(),
        services::executor_stubs::ExecutorProfileId::decl(),
        services::executor_stubs::ExecutorConfigs::decl(),
        services::executor_stubs::BaseAgentCapability::decl(),
        services::executor_stubs::CodingAgentStub::decl(),
        // REMOVED: Execution disabled - detailed executor types removed
...
// REMOVED: Execution disabled - no executor schemas to generate
fn generate_schemas() -> Result<HashMap<&'static str, String>, serde_json::Error> {
    println!("Skipping JSON schema generation (execution disabled)");
    let schemas: HashMap<&str, String> = HashMap::new();
    println!(
